...
const sq = {
  ...
  explore: {
    nav: "Krahaso patundshmëri",
    title: "Krahaso çmimet e patundshmërisë",
    subtitle:
      "Çmime të grupuara sipas llojit, qytetit dhe numrit të dhomave — mesatarja, mesatarja qendrore dhe €/m² për çdo grup.",
    ...
    apply: "Filtro",
    rooms: "dhoma",
    studio: "garsonjerë/1 dhomë",
    listingsLabel: "shpallje",
    avg: "mesatare",
    median: "median",
    range: "diapazoni",
    perMonth: "/muaj",
    none: "Asnjë grup nuk përputhet me filtrat. Provo t’i zgjerosh.",
    goodPrice: "nën mesataren",
    highPrice: "mbi mesataren",
    ofAvg: "e mesatares së grupit",
    coloredBy: "Ngjyrosur sipas €/m² (median)",
...
const en: typeof sq = {
  ...
  explore: {
    nav: "Compare real estate",
    title: "Compare real-estate prices",
    subtitle:
      "Prices grouped by type, city and bedroom count — average, median and €/m² for every group.",
    ...
    range: "range",
    perMonth: "/month",
    none: "No groups match these filters. Try widening them.",
    goodPrice: "below average",
    highPrice: "above average",
    ofAvg: "of group average",
    coloredBy: "Shaded by median €/m²",
